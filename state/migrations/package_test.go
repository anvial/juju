...
//go:generate go run go.uber.org/mock/mockgen -package migrations -destination description_mock_test.go github.com/juju/description/v10 ExternalController,OfferConnection,RemoteEntity,RelationNetwork,RemoteApplication,RemoteSpace,Status
