...
//go:generate go run go.uber.org/mock/mockgen -typed -package controllerpresence -destination caller_mocks_test.go github.com/juju/juju/internal/worker/apiremotecaller APIRemoteSubscriber,Subscription
