...
//go:generate go run go.uber.org/mock/mockgen -typed -package agentbinaryfetcher -destination lock_mock_test.go github.com/juju/juju/internal/worker/gate Lock
