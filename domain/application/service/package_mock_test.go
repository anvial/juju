...
func (m *MockState) IsImportingModel(arg0 context.Context, arg1 string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IsImportingModel", arg0, arg1)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStateMockRecorder) IsImportingModel(arg0, arg1 any) *MockStateIsImportingModelCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsImportingModel", reflect.TypeOf((*MockState)(nil).IsImportingModel), arg0, arg1)
...
// Do rewrite *gomock.Call.Do
func (c *MockStateIsImportingModelCall) Do(f func(context.Context, string) (bool, error)) *MockStateIsImportingModelCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockStateIsImportingModelCall) DoAndReturn(f func(context.Context, string) (bool, error)) *MockStateIsImportingModelCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
